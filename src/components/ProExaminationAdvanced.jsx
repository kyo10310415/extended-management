          ...
          prev.map(s => s.studentId === studentId
            ? {
                ...
                extensionData: {
                  ...
                  [`executive_check_${round}`]: data.data.executive_check,
                  [`revenue_extension_pending_${round}`]: data.data.revenue_extension_pending,
                  [`revenue_extension_completed_${round}`]: data.data.revenue_extension_completed,
                  [`revenue_extension_end_month_${round}`]: data.data.revenue_extension_end_month,
                  [`student_extension_notification_pending_${round}`]: data.data.student_extension_notification_pending,
                  [`student_extension_notification_sent_${round}`]: data.data.student_extension_notification_sent,
                  [`student_extension_notification_sent_at_${round}`]: data.data.student_extension_notification_sent_at,
            ...
            students={filteredStudents.map(s => ({
              ...
              extensionData: s.extensionData
                ? {
                    ...
                    executive_check: s.extensionData[`executive_check_${round}`],
                    revenue_extension_pending: s.extensionData[`revenue_extension_pending_${round}`],
                    revenue_extension_completed: s.extensionData[`revenue_extension_completed_${round}`],
                    revenue_extension_end_month: s.extensionData[`revenue_extension_end_month_${round}`],
                    student_extension_notification_pending: s.extensionData[`student_extension_notification_pending_${round}`],
                    student_extension_notification_sent: s.extensionData[`student_extension_notification_sent_${round}`],
                    student_extension_notification_sent_at: s.extensionData[`student_extension_notification_sent_at_${round}`],
